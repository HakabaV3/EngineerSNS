...
Comment.create!([
  {id: 1, owner: "kikurage", text: "それな", target: "/jinssk/project/JinsskProject", user_id: 1, project_id: 4},
  {id: 2, owner: "kikurage", text: "それはない", target: "/stogu/project/StoguProject", user_id: 1, project_id: 3}
])